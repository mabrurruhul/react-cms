...
export default function ChefEdit() {
    ...
    useEffect(() => {
        axios.get("http://localhost/reactjs/dingo/backend/chefs/getChef.php?id=" + id)
            .then((res) => {
                setName(res.data.name)
                console.log(res.data);
                setDetails(res.data.designation)
    ...
    const save = () => {
        ...
        axios.post("http://localhost/reactjs/dingo/backend/chefs/editChefs.php", formdata, {
            headers: {
